...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys('Black Swan\n')
    ...
    await driver.findElement(By.name('q')).sendKeys('Jaws\n')

    await driver.sleep(2000) 

    await driver.findElement(By.name('q')).clear()

    await driver.findElement(By.name('q')).sendKeys('It\'s Always Sunny in Philadelphia\n')
